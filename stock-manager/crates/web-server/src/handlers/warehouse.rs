...
use crate::dtos::warehouse::{
    WarehouseCreateRequest, WarehouseDto, WarehouseFormTemplate, WarehouseListTemplate,
...
pub async fn edit_warehouse_form(
    path: web::Path<Uuid>,
...
pub async fn create_warehouse(
    ...
    match service.create_warehouse(dto).await {
        Ok(warehouse) => {
            ...
            let status_text = if warehouse_dto.is_active {
                "Active"
            } else {
                "Inactive"
            };
        ...
        Err(e) => {
            Ok(HttpResponse::InternalServerError()
                .body(format!("Failed to create warehouse: {}", e)))
        }
    }
}
...
pub async fn update_warehouse(
    ...
    match service.update_warehouse(dto).await {
        ...
        Err(e) => {
            Ok(HttpResponse::InternalServerError()
                .body(format!("Failed to update warehouse: {}", e)))
        }
    }
}
...
pub async fn delete_warehouse(
    ...
    match service.delete_warehouse(warehouse_id).await {
        ...
        Err(e) => {
            Ok(HttpResponse::InternalServerError()
                .body(format!("Failed to delete warehouse: {}", e)))
        }
    }
}
